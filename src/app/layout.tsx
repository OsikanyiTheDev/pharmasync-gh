...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="min-h-screen bg-[#F3F4F7] text-slate-900 dark:bg-[#161719] dark:text-white antialiased flex flex-col font-sans transition-colors duration-200">
        <ThemeProvider>
          <ToastProvider>
            <OfflineProvider>
              <PharmacyProvider>
                <div className="flex min-h-screen bg-[#F3F4F7] dark:bg-[#161719]">
                  {/* Left Sidebar - Clinical Pearl Layout */}
