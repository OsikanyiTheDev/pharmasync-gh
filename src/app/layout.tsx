...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="bg-slate-100/70 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen flex flex-col font-sans transition-colors duration-200">
        <ThemeProvider>
          <ToastProvider>
            <OfflineProvider>
              <PharmacyProvider>
